...
INSERT INTO `patient` (`name`, `gender`, `dob`, `contact`, `email`, `username`, `password`) VALUES
('John Smith', 'male', '1973-09-18', 6109998735, 'jsmith@gmail.com', 'jsmith', 'password');
INSERT INTO `patient` (`name`, `gender`, `dob`, `contact`, `email`, `username`, `password`) VALUES
('Quinn Smith', 'male', '1993-02-13', 6109996543, 'qsmith@gmail.com', 'qsmith', 'password');
INSERT INTO `patient` (`name`, `gender`, `dob`, `contact`, `email`, `username`, `password`) VALUES
('Elaine Smith', 'female', '1975-05-17', 6109998721, 'esmith@gmail.com', 'esmith', 'password');

#Populate doctor data
INSERT INTO `doctor` (`did`, `name`, `gender`, `dob`, `experience`, `specialization`, `contact`, `address`, `username`, `password`, `region`) VALUES
(1, 'Jerry Martin', 'male', '1975-04-05', 20, 'Oncologist', 1234567890, '321 Eagle Road, Philadelphia, PA', 'doctor1', 'doctor1', 'Philadelphia');
INSERT INTO `doctor` (`did`, `name`, `gender`, `dob`, `experience`, `specialization`, `contact`, `address`, `username`, `password`, `region`) VALUES
(2, 'Alice Turner', 'female', '1985-07-11', 10, 'Pediatrician', 6103452387, '564 School Road, Philadelphia, PA', 'doctor2', 'doctor2', 'Philadelphia');
INSERT INTO `doctor` (`did`, `name`, `gender`, `dob`, `experience`, `specialization`, `contact`, `address`, `username`, `password`, `region`) VALUES
(3, 'Felix Jones', 'male', '1969-08-19', 20, 'Cardiologist', 5674320843, '2425 N 54th Street, Philadelphia, PA', 'doctor3', 'doctor3', 'Philadelphia');


#Populate manager data
INSERT INTO `manager` (`mid`, `name`, `gender`, `dob`, `contact`, `address`, `username`, `password`, `region`) VALUES
(1, 'Maureen McDonald', 'female', '1990-01-01', 2156530923, '498 Ford Road, Philadelphia, PA', 'mmcdonald', 'password', 'Philadelphia');

#Populate doctor_availability data
...
(1, 2, 'Monday', '14:00:00', '18:00:00'),
(1, 2, 'Thursday', '14:00:00', '18:00:00'),
(1, 2, 'Tuesday', '14:00:00', '18:00:00'),
(1, 2, 'Wednesday', '14:00:00', '18:00:00');
INSERT INTO `doctor_availability` (`cid`, `did`, `day`, `starttime`, `endtime`) VALUES
(1, 3, 'Friday', '14:00:00', '18:00:00'),
(1, 3, 'Monday', '14:00:00', '18:00:00'),
(1, 3, 'Thursday', '14:00:00', '18:00:00'),
(1, 3, 'Tuesday', '14:00:00', '18:00:00'),
(1, 3, 'Wednesday', '14:00:00', '18:00:00');
